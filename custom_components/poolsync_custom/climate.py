...
class PoolSyncClimate(CoordinatorEntity[PoolSyncDataUpdateCoordinator], ClimateEntity):
    ...
    def hvac_action(self) -> HVACAction:
        ...
        # Check if the heat pump is actively running using the same logic as binary sensors
        # We need both stateFlags and ctrlFlags to determine if actually running
        ...
        is_running = False
        if state_flags_value is not None and ctrl_flags_value is not None:
            try:
                ...
                # This matches the binary sensor logic
